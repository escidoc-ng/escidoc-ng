...
public class AuthorizeWorkspaceControllerIT extends AbstractAuthorizeLarchIT {
    ...
    @Test
    public void testBrowseWorkspace() throws Exception {
        testAuth(new AuthConfigurer.AuthConfigurerBuilder(
        ...
        testAuth(new AuthConfigurer.AuthConfigurerBuilder(
                ...
                .build());
        testAuth(new AuthConfigurer.AuthConfigurerBuilder(
                HttpMethod.GET, workspaceUrl + workspaceId + "/browse/1/2")
                .build());
    }

    @Test
    public void testBrowseWorkspaceHtml() throws Exception {
        testAuth(new AuthConfigurer.AuthConfigurerBuilder(
                HttpMethod.GET, workspaceUrl + workspaceId + "/browse")
                .html(true)
                .build());
