 ...
 */
package de.escidocng.exceptions;

import java.io.IOException;

/**
 * @author mih Exception indicating that a required parameter was not set.
 */
public class InvalidParameterException extends IOException {
    ...
    /**
     * Constructs an {@code InvalidParameterException} with {@code null} as its error detail message.
     */
    ...
    /**
     * Constructs an {@code InvalidParameterException} with the specified detail message and cause.
     * <p>
