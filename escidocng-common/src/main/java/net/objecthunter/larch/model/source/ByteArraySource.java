...
/**
 * This class is intended for passing the bytes of a {@link net.objecthunter.larch.model.Binary}'s
 * actual data. If for example a {@link net.objecthunter.larch.model.Binary} is ingested a ByteArraySource object is used to
