...
public class AuthorizeSearchControllerIT extends AbstractAuthorizeEscidocngIT {
    ...
    @Test
    @Ignore
    // test ignored since it seems to assume state in the repository, which is no longer given
