...
import static de.escidocng.test.util.Fixtures.LEVEL1_ID;
import static de.escidocng.test.util.Fixtures.LEVEL2_ID;
import static de.escidocng.test.util.Fixtures.createFixtureEntity;
import static de.escidocng.test.util.Fixtures.createRandomBinary;
...
import de.escidocng.integration.fs.helpers.NullOutputStream;
import de.escidocng.test.util.Fixtures;
import de.escidocng.test.util.SftpServerConfiguration;
...
import de.escidocng.model.AlternativeIdentifier.IdentifierType;
...
@SpringApplicationConfiguration(classes = { EscidocngServerConfiguration.class, SftpServerConfiguration.class })
@IntegrationTest
@WebAppConfiguration
@ActiveProfiles({"archive-sftp", "blobstore-fs"})
public abstract class AbstractFSEscidocngIT {
