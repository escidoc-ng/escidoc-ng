...
package net.objecthunter.larch.measurement;
...
//            "|| execution(* net.objecthunter.larch.service.impl.*.*(..)) " +
//            "|| execution(* net.objecthunter.larch.service.backend.elasticsearch.*.*(..)) " +
//            "|| execution(* net.objecthunter.larch.service.backend.fs.*.*(..)) " +
//            "|| execution(* net.objecthunter.larch.service.backend.weedfs.*.*(..)) ")
