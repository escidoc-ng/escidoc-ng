...
/**
 * A Factory class for creating different kinds of {@link de.escidocng.model.AuditRecord} objects
 */
public abstract class AuditRecordHelper {

    /**
     * Create an almost empty {@link de.escidocng.model.AuditRecord}
     * 
     * @param entityId the id of the Entity this {@link de.escidocng.model.AuditRecord} will be associated
     *        with
     * @return An almost empty {@link de.escidocng.model.AuditRecord} ready to be further filled
     */
    ...
    /**
     * Create an {@link de.escidocng.model.AuditRecord} for a "Create Entity" event
     * 
    ...
    /**
     * Create an {@link de.escidocng.model.AuditRecord} event for an "Update Entity" event
     * 
    ...
    /**
     * Create a {@link de.escidocng.model.AuditRecord} for a "Delete Entity" event
     * 
    ...
    /**
     * Create an {@link de.escidocng.model.AuditRecord} for a "Create Binary" event
     * 
    ...
    /**
     * create an {@link de.escidocng.model.AuditRecord} for an "Update Binary" event
     * 
     * @param entityId The id of the entity on which the {@link de.escidocng.model.Binary} got updated
     * @return
     */
    ...
    /**
     * Create an {@link de.escidocng.model.AuditRecord} for an "Delete Binary" event
     * 
    ...
    /**
     * Create an {@link de.escidocng.model.AuditRecord} for a "Create Relation" event
     * 
    ...
    /**
     * Create an {@link de.escidocng.model.AuditRecord} for a "Update Relation" event
     * 
     * @param entityId the is of the {@link de.escidocng.model.Entity} on which a relation got updated
     * @return
     */
    ...
    /**
     * Create an {@link de.escidocng.model.AuditRecord} for a "Delete Relation" event
     * 
     * @param entityId the id of the {@link de.escidocng.model.Entity} on which a relation got deleted
     * @return
     */
    ...
    /**
     * Create an {@link de.escidocng.model.AuditRecord} for a "Create Metadata" event
     * 
     * @param entityId the id of the {@link de.escidocng.model.Entity} on which the
     *        {@link de.escidocng.model.Metadata} gets created
     * @return
     */
    ...
    /**
     * Create an {@link de.escidocng.model.AuditRecord} for a "Update Metadata" event
     * 
     * @param entityId the id of the {@link de.escidocng.model.Entity} on which the
     *        {@link de.escidocng.model.Metadata} gets updated
     * @return
     */
    ...
    /**
     * Create an {@link de.escidocng.model.AuditRecord} for a "Delete Metadata" event
     * 
     * @param entityId the id of the {@link de.escidocng.model.Entity} on which the
     *        {@link de.escidocng.model.Metadata} got deleted
     * @return
     */
    ...
    /**
     * Create an {@link de.escidocng.model.AuditRecord} for a "Create binaryMetadata" event
     * 
     * @param entityId the id of the {@link de.escidocng.model.Entity} on which the
     *        {@link de.escidocng.model.Metadata} gets created
     * @return
    ...
    /**
     * Create an {@link de.escidocng.model.AuditRecord} for a "Update binary Metadata" event
     * 
     * @param entityId the id of the {@link de.escidocng.model.Entity} on which the
     *        {@link de.escidocng.model.Metadata} gets updated
     * @return
    ...
    /**
     * Create an {@link de.escidocng.model.AuditRecord} for a "Delete binary Metadata" event
     * 
     * @param entityId the id of the {@link de.escidocng.model.Entity} on which the
     *        {@link de.escidocng.model.Metadata} got deleted
     * @return
    ...
    /**
     * Create an {@link de.escidocng.model.AuditRecord} for a "Delete Identifier" event
     * 
     * @param entityId the id of the {@link de.escidocng.model.Entity} on which the identifier got deleted
     * @return
     */
    public static AuditRecord deleteIdentifier(String entityId) {
        final AuditRecord record = skeletonRecord(entityId);
        record.setAction(AuditRecord.EVENT_DELETE_IDENTIFIER);
        return record;
    }
