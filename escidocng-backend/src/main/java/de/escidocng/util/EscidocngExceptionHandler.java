 ...
 */
@ControllerAdvice
public class EscidocngExceptionHandler {

    private static final Logger log = LoggerFactory.getLogger(EscidocngExceptionHandler.class);
