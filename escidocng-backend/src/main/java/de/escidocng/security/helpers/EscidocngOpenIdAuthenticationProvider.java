 ...
 * @author mih
 */
public class EscidocngOpenIdAuthenticationProvider implements AuthenticationProvider {

    private static final Logger log = LoggerFactory.getLogger(EscidocngOpenIdAuthenticationProvider.class);
     ...
     * 
     * @param token
     * @return escidocng-user-object
     * @throws UsernameNotFoundException
     */
    private de.escidocng.model.security.User createUser(OpenIDAuthenticationToken token,
            String encryptedUserName)
            throws UsernameNotFoundException {
        de.escidocng.model.security.User user = new de.escidocng.model.security.User();
