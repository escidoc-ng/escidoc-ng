...
import de.escidocng.helpers.SizeCalculatingDigestInputStream;
...
import de.escidocng.model.EscidocngConstants;
...
import de.escidocng.model.source.UrlSource;
...
/**
 * The default implementation of {@link de.escidocng.service.EntityService} responsible for performing CRUD
 * operations of {@link de.escidocng.model.Entity} objects
 */
public class DefaultEntityService implements EntityService {
    ...
    public void createRelation(String id, String predicate, String object) throws IOException {
        if (object.startsWith("<" + EscidocngConstants.NAMESPACE_ESCIDOCNG)) {
            // the object is an internal entity
            final String objId = object.substring(1 + EscidocngConstants.NAMESPACE_ESCIDOCNG.length(), object.length() - 1);
