...
public class SearchController extends AbstractController {
     ...
     * GET which returns a JSON representation of the {@link net.objecthunter.larch.model.SearchResult}. The request
     ...
     *         {@link net.objecthunter.larch.model.security.User}s as s JSON representation
     */
