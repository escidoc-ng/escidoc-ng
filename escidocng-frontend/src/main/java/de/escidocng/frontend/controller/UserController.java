...
/**
 * Web controller class responsible for escidocng {@link de.escidocng.model.security.User} objects
 */
@Controller
public class UserController extends AbstractController {
    ...
    /**
     * Controller method for retrieving an existing {@link de.escidocng.model.security.User}s in the
