...
public class ArchiveController extends AbstractLarchController {
    ...
    @RequestMapping(value = "{entityId}/{version}", method = RequestMethod.GET, produces = "application/octet-stream")
    @ResponseStatus(HttpStatus.OK)
    public InputStream retrieve(@PathVariable("entityId") final String entityId, @PathVariable("version") final int version) throws IOException {
